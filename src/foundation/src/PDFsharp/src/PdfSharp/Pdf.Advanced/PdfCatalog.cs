...
namespace PdfSharp.Pdf.Advanced
{
    ...
    public sealed class PdfCatalog : PdfDictionary
    {
        ...
        public PdfArray? AssociatedFiles
        {
            get => Elements.GetArray(Keys.AssociatedFile);
            set
            {
                if (value == null!)
                    Elements.Remove(Keys.AssociatedFile);
                else
                    Elements.SetValue(Keys.AssociatedFile, value);
            }
        }
        ...
        internal sealed class Keys : KeysBase
        {
            ...
            /// <summary>
            /// (Optional; PDF 1.7) A dictionnary containing the reference of objects that are supposed to be
            /// associated with the PDF.
            /// </summary>
            [KeyInfo("1.7", KeyType.Name | KeyType.Optional)]
            public const string AssociatedFile = "/AF";
